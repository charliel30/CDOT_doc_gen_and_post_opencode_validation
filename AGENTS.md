...
6. **Produce the deliverable.** Generate a single markdown file called `cmgc_proposal.md` and place it in the output folder you find in the repository. This is your primary output.

7. **Produce the traceability manifest.** Generate a second file called `traceability.md` and place it alongside `cmgc_proposal.md` in the output folder. This file maps every major claim, fact, and data point in your proposal back to the specific source file and section it came from. See the **Traceability Manifest** section below for the required format.
...
13. Place both files (cmgc_proposal.md and traceability.md) in the output folder
```
